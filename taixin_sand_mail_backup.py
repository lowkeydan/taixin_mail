...
def mail_setting():
    ...
    mail_username_list = ['taixinpump.olivia@gmail.com', 'taixin.aaron@gmail.com', 'taixinpump.lucy@gmail.com',
                          'taixinpump.bob@gmail.com', 'taixinpump.daniel@gmail.com', 'taixinpump.lee@gmail.com', ]
    ...
    try:
        ...
        for value, address in enumerate(mail_address_list):
            try:
                ...
                random_mail_setting = mail_setting()
                mail_username = random_mail_setting[0]
                mail_password = random_mail_setting[1]
                subject = random_mail_setting[2]
                final_content = random_mail_setting[3]
                ...
                print("%s，连接超时，%s发送未成功。" % (value+1, address))
                continue
            except smtplib.SMTPServerDisconnected:
                print("Disconnected, reconnecting..")
                continue
            except smtplib.SMTPDataError:
                print('DataError, reconnecting..')
                continue
        print("发送完毕。")
    except TypeError:
        print("邮箱地址异常，请检查。")  # 若没有邮箱地址传入则报错
